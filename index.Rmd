...
load("/home/rstudio/PulsBiznesu/monitoring/data/sector.RData")
...
save(ind,sector,file="/home/rstudio/PulsBiznesu/monitoring/data/sector.RData")
...
#### 1. Zmiany indeksów na warszawskiej giełdzie
...
sectora<-sector2 %>% 
  ...
  sectora$color1[sectora$ch1<0]<-rgb(102-sectora$ch1[sectora$ch1<0]*20,0,0,maxColorValue = 255)
  sectora$color1[sectora$ch1>=0]<-rgb(0,102+sectora$ch1[sectora$ch1>=0]*20,0,maxColorValue = 255)
  sectora$color2[sectora$ch7<0]<-rgb(102-sectora$ch7[sectora$ch7<0]*20,0,0,maxColorValue = 255)
  sectora$color2[sectora$ch7>=0]<-rgb(0,102+sectora$ch7[sectora$ch7>=0]*20,0,maxColorValue = 255)
...
bp<-ggplot(p1,aes(x=date,y=Value))+
  ...
  theme(plot.margin = margin(0.7,1,0.7,0,"cm"))+
  xlab("")+
  ylab("")+
  labs(
    title=i
...
bp4<-ggplot(data=n3a,aes(x=date,y=value,group=spolka))+
  ...
  theme(strip.background = element_rect(fill="transparent",color="transparent"))+
  theme(strip.text = element_text(size=9,color="gray23", family="Publico Text"))+
  theme(axis.ticks=element_blank())+
  theme(axis.text.y=element_text(margin = margin(t=0,r=20,b=0,l=0,unit="pt"), family="Publico Text"))+
